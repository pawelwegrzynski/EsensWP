 ...
 switch(tempStr[i])
{
 ...
 if(this.XMLloadingWarning)
 {
 	if (this.setCheckList.length>0) this.setCheckList=this.setCheckList+',';
...
{img.style.width="0px";img.style.height="0px";}
 ...
 var idObject=String(itemObject.id);
 if (idObject.indexOf('fr',0)==0)
 {
	 itemObject.span.className="headerTreeRow";
 }
 else
 {
